...
$sql = "SELECT d.departmentName, CONCAT(e.firstName, ' ', e.lastName) AS employee_name
        FROM department d
        JOIN employee e ON d.departmentName = e.departmentName
          ...
          <div class="sidebar-contents">
            <div id="sidebar-menu" class="sidebar-menu">
              ...
              <ul>
                ...
                <li class="active">
                  <a href="#"><img src="assets/img/company.svg" alt="sidebar_img" /><span> Departments</span></a>
                </li>
                <li>
                  <a href="attendance.php"><img src="assets/img/calendar.svg" alt="sidebar_img" /><span>Attendance</span></a>
                </li>
                <li>
